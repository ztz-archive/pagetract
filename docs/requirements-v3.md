...
| **视频内容** | 视频中的语音信息和视觉信息 LLM 无法直接读取 | 音频转录（STT）+ VLM 视频理解，双路输出结构化文本 |
...
| **视频知识提取** | 将B站教学视频、技术分享等转为文字，纳入 LLM 知识库 |
...
| **B站视频** | Bilibili 视频 URL | 音频提取→STT 转录 + 关键帧提取→VLM 视频理解，输出两份 Markdown |
